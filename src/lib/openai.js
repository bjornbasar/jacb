...
export default async function getOpenAIResponse(message) {
    ...
    try {
        const response = await openai.chat.completions.create({
            ...
            messages: [
                { role: 'system', content: 'You are a helpful assistant chatbot. Keep responses concise and friendly.' },
        ...
        console.error('OpenAI error:', { message: err.message, type: err.type, code: err.code });
